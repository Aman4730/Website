          ...
          <div className="col-lg-4 text-lg-start text-center mb-4 mb-lg-0">
            <div className="title-area">
              ...
              <p className="text-muted mt-3">
                At <b>Logimetrix Techsolutions</b>, we are committed to helping
                businesses grow through cutting-edge technology and seamless
                digital transformation. Our team specializes in providing
                customized solutions that enhance operational efficiency,
                improve collaboration, and drive measurable success.
              </p>
              <p className="text-muted mt-3">
